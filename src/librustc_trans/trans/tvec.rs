...
pub fn trans_slice_vec<'blk, 'tcx>(bcx: Block<'blk, 'tcx>,
    ...
    if count > 0 {
        ...
        //FIXME: This drop_mem is weird... making a cleanup before the value is populated?
        fcx.schedule_drop_mem(cleanup_scope, llfixed, None, fixed_ty);
            ...
            match dest {
                ...
                SaveIn(lldest) => {
                    ...
                    for (i, element) in elements.iter().enumerate() {
                        ...
                        fcx.schedule_drop_mem(scope, lleltptr, None, vt.unit_ty);
                    }
